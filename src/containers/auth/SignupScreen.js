import {
  ...
  export default function SignupScreen({navigation}) {
    ...
    const _SignUpAsync = () => {
      let fname_error_flag = false;
      let lname_error_flag = false;
      let phone_error_flag = false;
      let email_error_flag = false;
      let password_error_flag = false;
      if (firstName == ''){
        fname_error_flag = false;
      ...
      if (lastName == ''){
        lname_error_flag = false;
        setLastNameError('Required field.');
      }else{
        setLastNameError('');
        lname_error_flag = true;
      }
      if (phone == ''){
        phone_error_flag = false;
        setPhoneError('Required field.');
      }else{
        if (phone.length < 10){
          phone_error_flag = false;
          setPhoneError('Not valid phone number.');
        }else{
          setPhoneError('');
          phone_error_flag = true;
        }
      }
      if (email == ''){
      ...
      if (fname_error_flag && lname_error_flag && phone_error_flag && email_error_flag && password_error_flag){
        let data = {
      ...
      <View>
          ...
          <View style={{flexDirection: 'row', justifyContent:'space-between' }}>
            ...
            <View style={Styles.errorContainer}>
              {
              lastNameError ?
              <Text style={{color:'red', marginRight:57}}>{lastNameError}</Text>:
              null
              } 
            </View>
          </View>
            ...
            <View style={{flex:2}}>
              ...
              <RNPickerSelect
                    ...
                    onValueChange={(itemValue, itemIndex) => {
                      ...
                      setSelectedCode(countryCodes[itemIndex].dial_code)
                    }}
          ...
          <TouchableOpacity style={Styles.loginContainer} onPress={_SignUpAsync}>
